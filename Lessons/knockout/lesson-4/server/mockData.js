...
{
	return {
		getMeerkats: function(){
			var base_url = 'http://cdn.comparethemarket.com/meerkat/0.0.0.0/Templates/Styles/Meerkats/PageFiles';
			return [{ name: 'Sergei', type: 'smart', dateOfBirth: '1937-04-10', picture_href: base_url + '/115/sergei.png' },
			{ name: 'Yakov', type: 'hairy', dateOfBirth: '1943-12-20', picture_href: base_url + '/109/Yakov.png' }, 
			{ name: 'Aleksandr', type: 'baby', dateOfBirth: '1976-01-21', picture_href: base_url + '/113/Alek_profile.png' }, 
			{ name: 'Bobby', type: 'smart', dateOfBirth: '1922-04-10', picture_href: base_url + '/115/sergei.png' },
			{ name: 'Frogger', type: 'smart', dateOfBirth: '1941-12-20', picture_href: base_url + '/109/Yakov.png' },
			{ name: 'Mona', type: 'hairy', dateOfBirth: '1979-01-21', picture_href: base_url + '/113/Alek_profile.png' }]
		},
